...
def banner(console=None):
    ...
    # Clear screen for Windows or Unix
    ...
    print(Fore.YELLOW + "*   " + Style.BRIGHT + Fore.RED + brand_name + Fore.YELLOW + "   *")
    print(Fore.YELLOW + border)
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            console.print(f"[bold cyan]  >> Name        : {data.get('Name', 'UNDEFINED')}[/bold cyan]")
            console.print(f"[bold cyan]  >> LocalID     : {data.get('localID', 'UNDEFINED')}[/bold cyan]")
            console.print(f"[bold cyan]  >> Money       : {data.get('money', 'UNDEFINED')}[/bold cyan]")
            console.print(f"[bold cyan]  >> Coins       : {data.get('coin', 'UNDEFINED')}[/bold cyan]")
            friends_count = len(data.get("FriendsID", []))
            console.print(f"[bold cyan]  >> Friends     : {friends_count}[/bold cyan]")
            car_data = data.get("carIDnStatus", {}).get("carGeneratedIDs", [])
            unique_car_data = set(car_data)
            car_count = len(unique_car_data)
            console.print(f"[bold cyan]  >> Cars        : {car_count}[/bold cyan]")
...
def load_key_data(cpm):
    ...
    console.print(f"[bold cyan]  >> Access Key  [/bold cyan]: [yellow]{data.get('ASA KA BOY')}[/yellow]")
    
    console.print(f"[bold cyan]  >> Telegram ID : {data.get('telegram_id')}[/bold cyan]")
    
    console.print(f"[bold cyan]  >> Balance     : {data.get('coins') if not data.get('is_unlimited') else 'Unlimited'}[/bold cyan]")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold yellow][bold red](01)[/bold red]: Increase Money                 [bold red]1.5K[/bold red][/bold yellow]")            
            console.print("[bold yellow][bold red](02)[/bold red]: Increase Coins                 [bold red]1.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](03)[/bold red]: King Rank                      [bold red]8K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](04)[/bold red]: Change ID                      [bold red]4.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](05)[/bold red]: Change Name                    [bold red]100[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](06)[/bold red]: Change Name (rainbow)          [bold red]100[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](07)[/bold red]: Number Plates                  [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](08)[/bold red]: Account Delete                 [bold red]Free[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](09)[/bold red]: Account Register               [bold red]Free[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](10)[/bold red]: Delete Friends                 [bold red]500[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](11)[/bold red]: Unlock Lamborghinis (ios only) [bold red]5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](12)[/bold red]: Unlock All Cars                [bold red]6K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](13)[/bold red]: Unlock All Cars Siren          [bold red]3.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](14)[/bold red]: Unlock W16 Engine              [bold red]4K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](15)[/bold red]: Unlock All Horns               [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](16)[/bold red]: Unlock Disable Damage          [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](17)[/bold red]: Unlock Unlimited Fuel          [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](18)[/bold red]: Unlock Home 3                  [bold red]4K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](19)[/bold red]: Unlock Smoke                   [bold red]4K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](20)[/bold red]: Unlock Wheels                  [bold red]4K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](21)[/bold red]: Unlock Animations              [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](22)[/bold red]: Unlock Equipaments M           [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](23)[/bold red]: Unlock Equipaments F           [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](24)[/bold red]: Change Race Wins               [bold red]1K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](25)[/bold red]: Change Race Loses              [bold red]1K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](26)[/bold red]: Clone Account                  [bold red]7K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](27)[/bold red]: Custom HP                      [bold red]2.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](28)[/bold red]: Custom Angle                   [bold red]1.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](29)[/bold red]: Custom Tire burner             [bold red]1.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](30)[/bold red]: Custom Car Millage             [bold red]1.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](31)[/bold red]: Custom Car Brake               [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](32)[/bold red]: Remove Rear Bumper             [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](33)[/bold red]: Remove Front Bumper            [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](34)[/bold red]: Change Account Password        [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](35)[/bold red]: Change Account Email           [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](36)[/bold red]: Custom Spoiler                 [bold red]10K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](37)[/bold red]: Custom BodyKit                 [bold red]10K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](38)[/bold red]: Unlock Premium Wheels          [bold red]4.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](39)[/bold red]: Unlock Toyota Crown            [bold red]2K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](40)[/bold red]: Unlock Clan Hat (m)            [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](41)[/bold red]: Remove Head Male               [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](42)[/bold red]: Remove Head Female             [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](43)[/bold red]: Unlock Clan Top 1 (m)          [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](44)[/bold red]: Unlock Clan Top 2 (m)          [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](45)[/bold red]: Unlock Clan Top 3 (m)          [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](46)[/bold red]: Unlock Clan Top 1 (fm)         [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](47)[/bold red]: Unlock Clan Top 2 (fm)         [bold red]3K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](48)[/bold red]: Unlock Mercedes Cls            [bold red]4K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](49)[/bold red]: Stance Camber                  [bold red]1K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](50)[/bold red]: Custom HP  All  Cars           [bold red]2.5K[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](51)[/bold red]: Login Another Account          [bold red]Free[/bold red][/bold yellow]")
            console.print("[bold yellow][bold red](0) [/bold red]: Exit From AidenTool [/bold yellow]")
            
            console.print("[bold red]===============[bold cyan][ JDs TOOL ][/bold cyan]===============[/bold red]")
            ...
            if service == 0: # Exit
                ...
                sleep(2)
                console.print("[%] Aiden has Giving you a King Rank: ", end=None)
                ...
                console.print("[bold cyan][!] Note[/bold cyan]: This will modify ALL your cars' speed!")
                console.print("[bold cyan][!] Enter New Engine Specs.[/bold cyan]")
                new_hp = IntPrompt.ask("[bold][?] Enter New HP[/bold]")
                new_inner_hp = IntPrompt.ask("[bold][?] Enter New Inner HP[/bold]")
                new_nm = IntPrompt.ask("[bold][?] Enter New NM[/bold]")
                new_torque = IntPrompt.ask("[bold][?] Enter New Torque[/bold]")
